...
const DriverDashboard = () => {
  ...
  // Authentication check (debug logs removed)
  ...
  // Fetching deliveries for driver
  ...
  // response status available via response.status
  ...
  // parsed response data available
      ...
      if (response.ok) {
        ...
        if (Array.isArray(data)) {
          ...
          // Deliveries response shape unexpected; defaulting to empty array
          setDeliveries([]);
        }
        setMessage("");
      } else {
              ...
              <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between">
                <div className="flex items-center space-x-8 mb-8 xl:mb-0">
                  ...
                  <div>
                    ...
                    <p className="text-xl text-gray-700 font-semibold animate-fadeInUp flex items-center space-x-3" style={{animationDelay: '0.1s'}}>
                      <span>Welcome back,</span>
                      <span className="text-blue-700 font-black">{driver.profile?.name || driver.username}</span>
              ...
              <div className="p-8 space-y-6 bg-gradient-to-br from-slate-50 to-blue-50">
                <div className="flex items-center space-x-6 p-6 bg-white rounded-2xl hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-500 group/item shadow-lg hover:shadow-xl border border-gray-100 stagger-animation" style={{'--stagger': 1}}>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-gray-900 font-black text-lg">{driver.profile?.name || driver.username}</div>
                ...
                <div className="flex items-center space-x-6 p-6 bg-white rounded-2xl hover:bg-gradient-to-r hover:from-emerald-50 hover:to-green-50 transition-all duration-500 group/item shadow-lg hover:shadow-xl border border-gray-100 stagger-animation" style={{'--stagger': 2}}>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-gray-900 font-black text-lg break-all">{driver.email}</div>
                          ...
                          <div className="space-y-4">
                            ...
                            {delivery.order?.shippingAddress ? (
                              ...
                              <div className="p-4 bg-gray-100 rounded-xl text-center">
                                <span className="text-gray-500 font-medium">{delivery.order?.user || "N/A"}</span>
                              </div>
                            )}
                          </div>
